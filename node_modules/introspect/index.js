var ownKeys          = Object.keys,
    ...
    builtins = ['Array', 'Boolean', 'Function', 'Map', 'Number', 'Object',
                'Proxy', 'RegExp', 'Set', 'String', 'WeakMap'
                ].map(function(s){ return global[s] }).filter(Boolean),

    builtinProtos = builtins.map(function(Ctor){ return Ctor.prototype }),
